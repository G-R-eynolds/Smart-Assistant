...
async function scrapeLinkedIn() {
    ...
    try {
        ...
        await page.goto('https://www.linkedin.com/jobs/search?keywords=Senior+Software+Engineer+Software+Developer+Software+Programmer+Python+PyTorch+Machine+Learning+Deep+Learning+Neural+Networks+Transformer+Architectures&location=San+Francisco&f_TPR=r604800', { 
