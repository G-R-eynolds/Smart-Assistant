"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[4038],{85629:function(e,t,r){r.d(t,{$:function(){return TwitterAuthProvider},A:function(){return u},G:function(){return debugErrorMap},K:function(){return connectAuthEmulator},L:function(){return AuthCredential},N:function(){return OAuthCredential},P:function(){return PhoneAuthProvider},R:function(){return RecaptchaVerifier},U:function(){return g},V:function(){return EmailAuthProvider},W:function(){return FacebookAuthProvider},X:function(){return GoogleAuthProvider},Y:function(){return GithubAuthProvider},Z:function(){return OAuthProvider},_:function(){return SAMLAuthProvider},a:function(){return T},a0:function(){return signInAnonymously},a1:function(){return signInWithCredential},a2:function(){return linkWithCredential},a3:function(){return reauthenticateWithCredential},a4:function(){return signInWithCustomToken},a5:function(){return sendPasswordResetEmail},a6:function(){return confirmPasswordReset},a7:function(){return applyActionCode},a8:function(){return checkActionCode},a9:function(){return verifyPasswordResetCode},aA:function(){return _isIOS7Or8},aB:function(){return _createError},aC:function(){return _assert},aD:function(){return AuthEventManager},aE:function(){return _getInstance},aF:function(){return _persistenceKeyName},aG:function(){return _getRedirectResult},aH:function(){return _overrideRedirectResult},aI:function(){return _clearRedirectOutcomes},aJ:function(){return _castAuth},aN:function(){return _generateEventId},aQ:function(){return SAMLAuthCredential},aa:function(){return createUserWithEmailAndPassword},ab:function(){return signInWithEmailAndPassword},ac:function(){return sendSignInLinkToEmail},ad:function(){return isSignInWithEmailLink},ae:function(){return signInWithEmailLink},af:function(){return fetchSignInMethodsForEmail},ag:function(){return sendEmailVerification},ah:function(){return verifyBeforeUpdateEmail},ak:function(){return updateProfile},al:function(){return updateEmail},am:function(){return updatePassword},ap:function(){return unlink},aq:function(){return getAdditionalUserInfo},as:function(){return getMultiFactorResolver},at:function(){return multiFactor},au:function(){return debugAssert},av:function(){return _isIOS},aw:function(){return _isAndroid},ax:function(){return _fail},ay:function(){return _getRedirectUrl},az:function(){return _getProjectConfig},b:function(){return y},c:function(){return signInWithPopup},d:function(){return linkWithPopup},e:function(){return reauthenticateWithPopup},f:function(){return signInWithRedirect},g:function(){return linkWithRedirect},h:function(){return reauthenticateWithRedirect},i:function(){return E},j:function(){return getRedirectResult},k:function(){return H},l:function(){return linkWithPhoneNumber},m:function(){return PhoneMultiFactorGenerator},p:function(){return c},r:function(){return reauthenticateWithPhoneNumber},s:function(){return signInWithPhoneNumber},u:function(){return updatePhoneNumber}});var i,n=r(53644),s=r(19393),a=r(56914),o=r(50044),l=r(77905);let c={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",PHONE:"phone",TWITTER:"twitter.com"},u={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let debugErrorMap=/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function recachePasswordPolicy(e){let t=_castAuth(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}async function sendPasswordResetEmail(e,t,r){let i=_castAuth(e),n={requestType:"PASSWORD_RESET",email:t,clientType:"CLIENT_TYPE_WEB"};r&&_setActionCodeSettingsOnRequest(i,n,r),await handleRecaptchaFlow(i,n,"getOobCode",sendPasswordResetEmail$1)}async function confirmPasswordReset(e,t,r){await resetPassword((0,n.m9)(e),{oobCode:t,newPassword:r}).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t})}async function applyActionCode(e,t){await applyActionCode$1((0,n.m9)(e),{oobCode:t})}async function checkActionCode(e,t){let r=(0,n.m9)(e),i=await resetPassword(r,{oobCode:t}),s=i.requestType;switch(_assert(s,r,"internal-error"),s){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":_assert(i.newEmail,r,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":_assert(i.mfaInfo,r,"internal-error");default:_assert(i.email,r,"internal-error")}let a=null;return i.mfaInfo&&(a=MultiFactorInfoImpl._fromServerResponse(_castAuth(r),i.mfaInfo)),{data:{email:("VERIFY_AND_CHANGE_EMAIL"===i.requestType?i.newEmail:i.email)||null,previousEmail:("VERIFY_AND_CHANGE_EMAIL"===i.requestType?i.email:i.newEmail)||null,multiFactorInfo:a},operation:s}}async function verifyPasswordResetCode(e,t){let{data:r}=await checkActionCode((0,n.m9)(e),t);return r.email}async function createUserWithEmailAndPassword(e,t,r){let i=_castAuth(e),n=handleRecaptchaFlow(i,{returnSecureToken:!0,email:t,password:r,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",signUp),s=await n.catch(t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t}),a=await UserCredentialImpl._fromIdTokenResponse(i,"signIn",s);return await i._updateCurrentUser(a.user),a}function signInWithEmailAndPassword(e,t,r){return signInWithCredential((0,n.m9)(e),EmailAuthProvider.credential(t,r)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&recachePasswordPolicy(e),t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sendSignInLinkToEmail(e,t,r){let i=_castAuth(e),n={requestType:"EMAIL_SIGNIN",email:t,clientType:"CLIENT_TYPE_WEB"};_assert(r.handleCodeInApp,i,"argument-error"),r&&_setActionCodeSettingsOnRequest(i,n,r),await handleRecaptchaFlow(i,n,"getOobCode",sendSignInLinkToEmail$1)}function isSignInWithEmailLink(e,t){let r=ActionCodeURL.parseLink(t);return(null==r?void 0:r.operation)==="EMAIL_SIGNIN"}async function signInWithEmailLink(e,t,r){let i=(0,n.m9)(e),s=EmailAuthProvider.credentialWithLink(t,r||_getCurrentUrl());return _assert(s._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),signInWithCredential(i,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let BrowserPersistenceClass=class BrowserPersistenceClass{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{if(!this.storage)return Promise.resolve(!1);return this.storage.setItem(w,"1"),this.storage.removeItem(w),Promise.resolve(!0)}catch(e){return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){let t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}};let BrowserLocalPersistence=class BrowserLocalPersistence extends BrowserPersistenceClass{constructor(){super(()=>window.localStorage,"LOCAL"),this.boundEventHandler=(e,t)=>this.onStorageEvent(e,t),this.listeners={},this.localCache={},this.pollTimer=null,this.safariLocalStorageNotSynced=/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let BrowserSessionPersistence=class BrowserSessionPersistence extends BrowserPersistenceClass{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}};BrowserSessionPersistence.type="SESSION";let T=BrowserSessionPersistence;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let S=_generateCallbackName("rcb"),R=new Delay(3e4,6e4);let ReCaptchaLoaderImpl=class ReCaptchaLoaderImpl{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!(null===(e=_window().grecaptcha)||void 0===e?void 0:e.render)}load(e,t=""){return(_assert(t.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(t),e,"argument-error"),this.shouldResolveImmediately(t)&&isV2(_window().grecaptcha))?Promise.resolve(_window().grecaptcha):new Promise((r,i)=>{let s=_window().setTimeout(()=>{i(_createError(e,"network-request-failed"))},R.get());_window()[S]=()=>{_window().clearTimeout(s),delete _window()[S];let n=_window().grecaptcha;if(!n||!isV2(n)){i(_createError(e,"internal-error"));return}let a=n.render;n.render=(e,t)=>{let r=a(e,t);return this.counter++,r},this.hostLanguage=t,r(n)};let a=`${_.recaptchaV2Script}?${(0,n.xO)({onload:S,render:"explicit",hl:t})}`;_loadJS(a).catch(()=>{clearTimeout(s),i(_createError(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!(null===(t=_window().grecaptcha)||void 0===t?void 0:t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}};let MockReCaptchaLoaderImpl=class MockReCaptchaLoaderImpl{async load(e){return new MockReCaptcha(e)}clearedOneInstance(){}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let U=new Delay(3e4,6e4);function resetUnloadedGapiModules(){let e=_window().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let D=null,F=new Delay(5e3,15e3),W={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},x=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function _openIframe(e){let t=await (D=D||new Promise((t,r)=>{var i,n,s;function loadGapiIframe(){resetUnloadedGapiModules(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{resetUnloadedGapiModules(),r(_createError(e,"network-request-failed"))},timeout:U.get()})}if(null===(n=null===(i=_window().gapi)||void 0===i?void 0:i.iframes)||void 0===n?void 0:n.Iframe)t(gapi.iframes.getContext());else if(null===(s=_window().gapi)||void 0===s?void 0:s.load)loadGapiIframe();else{let t=_generateCallbackName("iframefcb");return _window()[t]=()=>{gapi.load?loadGapiIframe():r(_createError(e,"network-request-failed"))},_loadJS(`${_.gapiScript}?onload=${t}`).catch(e=>r(e))}}).catch(e=>{throw D=null,e})),r=_window().gapi;return _assert(r,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;_assert(t.authDomain,e,"auth-domain-config-required");let r=t.emulator?_emulatorUrl(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:s.SDK_VERSION},a=x.get(e.config.apiHost);a&&(i.eid=a);let o=e._getFrameworks();return o.length&&(i.fw=o.join(",")),`${r}?${(0,n.xO)(i).slice(1)}`}(e),messageHandlersFilter:r.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:W,dontclear:!0},t=>new Promise(async(r,i)=>{await t.restyle({setHideOnLeave:!1});let n=_createError(e,"network-request-failed"),s=_window().setTimeout(()=>{i(n)},F.get());function clearTimerAndResolve(){_window().clearTimeout(s),r(t)}t.ping(clearTimerAndResolve).then(clearTimerAndResolve,()=>{i(n)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}(i)),(0,s.registerVersion)(z,G,"esm2017")}}]);